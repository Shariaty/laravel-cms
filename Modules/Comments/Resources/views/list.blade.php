        ...
        <div class="panel panel-grey">
            ...
            <div class="panel-body">
                <table class="table table-bordered table-responsive" id="list-table" style="width: 100%; display: none; text-align: center; font-family: Tahoma, Helvetica, Arial;">
                    <thead>
                    <tr>
                        <th class="center-text" width="50">status</th>
                        <th class="center-text">Comment</th>
                        <th class="center-text" width="125">Commented on</th>
...
<script src="{{ Module::asset('comments:js/module.js') }}" type="application/javascript"></script>
<script>
M6Module.commentsList();
M6Module.ajaxStatusChange('comments/AjaxStatusUpdate');
</script>
@stop