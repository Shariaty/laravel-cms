            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('route' => ['admin.articles.categories.create'], 'method' => 'POST' , 'id' => 'AddNewsCategoryForm')) !!}
                        <div class="col-md-12">
                            <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="">
                                <div class="pull-right">
                                    <a href="{{route('admin.articles.categories')}}" class="btn btn-danger">Cancel</a>
...
@section('header')
<link href="{{ Module::asset('articles:plugins/icheck/skins/all.css') }}" rel="stylesheet" type="text/css" />
@stop

@section('moduleFooter')
<script src="{{ Module::asset('articles:plugins/icheck/icheck.min.js') }}" type="application/javascript"></script>
