    ...
    <div class="col-md-12 col-xs-12">
            <div class="panel panel-grey">
                <div class="panel-heading">
                    ...
                    <a href="{{route('admin.articles.add')}}" class="btn btn-xs btn-success" style="margin-top: -2px;">+ Add New</a>
                </span>
                </div>
...
<script>
M6ARTICLES.ajaxStatusChange('articles/AjaxStatusUpdate');
M6ARTICLES.articlesList();
</script>
@stop
