        ...
        <div class="panel panel-grey">
            <div class="panel-heading">
                ...
                <span class="pull-right">
                    <a href="{{route('admin.inventory.pdf')}}" class="btn btn-xs btn-danger farsi-text" style="margin-top: -2px;">
                        <i class="fa fa-file-pdf-o"></i>
                        دانلود فایل گزارش انبار
                    </a>
                </span>
            </div>
            <div class="panel-body">
                <table class="table table-bordered table-responsive" id="list-table" style="width: 100%; display: none; text-align: center; font-family: Tahoma, Helvetica, Arial;">
                    <thead>
                    <tr>
                        <th class="center-text" width="120">کد کالا</th>
                        <th class="center-text" >عنوان</th>
                        <th class="center-text" width="100" >واحد شمارش</th>
                        <th class="center-text" width="60">وارده</th>
                        <th class="center-text" width="60" >صادره</th>
                        <th class="center-text" width="60" >موجودی</th>
                    </tr>
                    </thead>
                </table>
            </div>
