...
Invoice.prototype = {
    ...
    newRow: function () {
        jQuery(".item-row:last").after(
            ...
            '<select class="form-control item" name="item[]" style="width: 100%;"></select>' +
            ...
            '<td>' +
            '<div class="form-group">' +
            '<input class="form-control qty qty_value" name="qty[]['+Math.random()+']" placeholder="Quantity" type="number">' +
            '<span class="validation-message-block"></span>' +
            '</div>' +
            '</td>' +
