...
<div id="logo-thumb-container">
    @if($magazine->file)
        <a href="{{route('admin.magazines.fileView' , $magazine)}}" class="resume-upload-link btn btn-xs btn-info" style="margin-left: 3px;" target="_blank">
            <i class="fa fa-eye fa-1x"></i>&nbsp;View
        </a>
        <a href="{{route('admin.magazines.removeFile' ,  $magazine->id)}}" class="resume-upload-link confirmation-remove btn btn-xs btn-danger">
