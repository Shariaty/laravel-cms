            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('route' => ['admin.portfolio.categories.create'], 'method' => 'POST' , 'files' => true ,'id' => 'ProductCategoryForm')) !!}
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-icon right">
                                            <input type="file" name="image" accept="image/*" id="file" class="form-control">
