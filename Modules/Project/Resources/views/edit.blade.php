            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::model($project , array('route' => ['admin.projects.update' , $project ], 'method' => 'POST' , 'files' => true , 'id' => 'PostEditForm')) !!}
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-xs-12">
                                        <div class="md-checkbox" style="margin-top: 30px;">
                                            <input name="is_expired" type="checkbox" id="checkbox1" class="md-check" {{$project->is_expired == 'Y' ? 'checked' : ''}}>
                                            <label for="checkbox1">
                                                <span class="inc"></span>
                                ...
                                <div class="col-md-5 col-xs-12">
                                    ...
                                    @if($project->img)
                                        ...
                                        <div class="image-container">
                                            <img src="{{asset('uploads/admins/project-pictures/'.$project->img)}}">
                                            <span class="image-container-btn">
                                              <a href="{{route('admin.projects.image.delete' , $project)}}" class="btn btn-xs red confirmation-remove">Remove</a>
                                            </span>
                                        </div>
                            ...
                            <div class="">
                                <div class="pull-right">
                                    ...
                                    <button type="submit" class="btn btn-success" id="btn_project">Update</button>
                                </div>
                            </div>
                        </div>
                        </div>
