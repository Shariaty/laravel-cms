        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-grey">
                <div class="panel-heading">
                    ...
                    <a href="{{route('admin.priceList.add')}}" class="btn btn-xs btn-success" style="margin-top: -2px;">+ Create Price List</a>
                    </span>
                </div>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-responsive" id="list-table" style="width: 100%; display: none; text-align: center; font-family: Tahoma, Helvetica, Arial;">
                        <thead>
                        <tr>
                            <th class="center-text" width="100">Price List Code</th>
                            <th class="center-text" width="150">Created At</th>
                            <th class="center-text" width="150">Modified At</th>
