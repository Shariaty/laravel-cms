                        ...
                        <table class="table table-bordered table-responsive-lg card-table" style="margin-top: 20px">
                            ...
                            @foreach($invoiceGoods as $good)
                                <tr>
                                    ...
                                    <td class="text-center"><span>{{ generateUnitView($good->product) }}</span></td>
                                    <td class="text-center"><span>{{ $good->quantity }}</span></td>
                                    <td class="text-center price"><span>{{ $good->sale_price }}</span></td>
                                    <td class="text-center price"><span>{{ $good->sale_price * ( $good->product->conversion_factor ? $good->product->conversion_factor : 1 ) }}</span></td>
                                </tr>
                            @endforeach

                            <tr>
                                <th colSpan="5"><span class="pull-right"><strong>جمع کل مبلغ قابل پرداخت</strong></span></th>
                                <th class="text-center price" style="background-color: #d3ffd3">
                                    {{ $invoice->total_price }}
                                </th>
                            </tr>
