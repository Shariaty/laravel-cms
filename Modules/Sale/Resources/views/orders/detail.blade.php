                ...
                <div class="portlet">
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            @if($invoice->wareHouseOutGo)
                                <a href="{{route('admin.warehouse.outgo.detail' , $invoice->wareHouseOutGo)}}" class="btn btn-xs btn-warning pull-left printable-visible">
                                    نمایش حواله خروج از انبار
                                </a>
                                <br/>
                            @endif
