            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model( $invoice , array('route' => ['admin.sale.update' , $invoice] , 'method' => 'POST' , 'id' => 'FormInvoice')) !!}
                        ...
                        <div class="col-md-4 col-xs-12" style="text-align: center; margin-top: 30px;">
                        ...
                        <div class="col-md-4 col-xs-12" style="float: right; text-align: right;">
                            <div class="form-group {{ $errors->has('user') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('user' , $usersList  , $invoice->user_id ? $invoice->user_id : null  , ['class' => 'form-control user_list' , 'style' => 'width: 100%']) !!}
                                                ...
                                                <tr class="item-row">
                                                    <td class="item-name">
                                                        <div class="delete-btn">
                                                            {!! Form::select('item[]' , $productList  , $goods->product_id , ['class' => 'select2 form-control item product_selector' , 'style' => 'width: 100%']) !!}
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input class="form-control price price_value" name="price[][{{random_int(111,99999)}}]"  placeholder="Price" value="{{$goods->sale_price}}" type="number" />
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            {!! Form::select('unit[]['.random_int(11111,99999).']' , $goods->unitList ? $goods->unitList : []  , $goods->unit_id , ['class' => 'select2 form-control unit_list' , 'style' => 'width: 100%']) !!}
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div style="display: inline-flex">
                                                                <input style="width:130px" class="form-control qty qty_value" name="qty[][{{random_int(111,99999)}}]" placeholder="Quantity" value="{{$goods->quantity}}" type="number">
                                                                <span class="conversion"> X {{ $goods->final_quantity / $goods->quantity }} </span>
                                                            </div>
                                                            <span style="width: 100%" class="validation-message-block"></span>
                                                            </div>
                                                    </td>

                                                    <td><span class="total mask-price">0</span></td>
                                                    <input class="form-control con" name="con[][{{random_int(11111,99999)}}]" value="{{ $goods->final_quantity / $goods->quantity }}" type="hidden">
                                                    <input class="form-control helperCon" value="{{ $goods->con }}" type="hidden">
                                                    </tr>
                                            @endforeach
                                        @endif
