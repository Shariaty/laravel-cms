        ...
        <div class="panel-body form">
            <div class="panel panel-grey">
                ...
                <div class="panel-body">
                    {!! Form::model($cat , array('route' => ['admin.products.categories.update' , $cat], 'method' => 'POST' , 'id' => 'ProductCategoryForm')) !!}
                    <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="form-group {{ $errors->has('options') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-icon right">
                                        @if($errors->has('options'))
                                            <i class="fa fa-exclamation tooltips" data-container="body"></i>
                                        @endif
                                        {!! Form::select('options[]' , $options , $selectedOptions , ['class' => 'form-control input-sm select2',  'size' => 1 , 'multiple' , 'style' => 'width: 100%' , 'id' => 'options_list' ]) !!}
                                ...
                                <div class="form-group {{ $errors->has('manufactures') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-icon right">
                                        @if($errors->has('manufactures'))
                                            <i class="fa fa-exclamation tooltips" data-container="body"></i>
                                        @endif
                                        {!! Form::select('manufactures[]' , $manufactures , $selectedManufactures , ['class' => 'form-control input-sm select2',  'size' => 1 , 'multiple' , 'style' => 'width: 100%' , 'id' => 'manufactures_list' ]) !!}
