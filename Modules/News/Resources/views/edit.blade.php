            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::model($news , array('route' => ['admin.news.update' , $news ], 'method' => 'POST' , 'files' => true , 'id' => 'AddNewsForm')) !!}
                                ...
                                <div class="col-md-5 col-xs-12">
                                    ...
                                    @if($news->img)
                                        ...
                                        <div class="image-container">
                                            <img src="{{asset('uploads/admins/news-pictures/'.$news->img)}}">
                                            <span class="image-container-btn">
                                              <a href="{{route('admin.news.image.delete' , $news)}}" class="btn btn-xs red confirmation-remove">Remove</a>
                                            </span>
                                        </div>
