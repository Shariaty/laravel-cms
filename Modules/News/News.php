...
class News extends Model
{
    ...
    protected $fillable = [
        'id' , 'title', 'slug' , 'body' , 'img' , 'is_published' , 'views'
    ];
    ...
    {
        return $this->belongsToMany( NewsCat::class , 'news_newscategories' , 'news_id' , 'category_id')->withTimestamps();
    }

    public function comments()
    {
        return $this->morphMany('App\Admin\Comment', 'commentable');
    }
