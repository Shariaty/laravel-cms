        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-grey">
                <div class="panel-heading">
                    ...
                    <a href="{{route('admin.magazines.categories.add')}}" class="btn btn-xs btn-success" style="margin-top: -2px;">+ Add New</a>
                </span>
                </div>
                            ...
                            <table class="table table-bordered table-hover" id="staticDataTable" style="width: 100%; display: none; text-align: center !important;">
                                ...
                                @foreach($categories as $cat)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.magazines.categories.edit' , $cat)}}">
                                                {{$cat->title}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td class="center-text">
                                            <span class="badge badge-success"> {{ $cat->magazines->count() }} </span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-xs btn-group-solid">
                                                <a href="{{route('admin.magazines.categories.edit' , $cat)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('admin.magazines.categories.delete' , $cat)}}" class="btn red confirmation-remove" data-items="{{$cat->magazines->count()}}"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
...
<script>
M6Module.ajaxStatusChange('magazines/categories/AjaxStatusUpdate');
M6Module.catList();
</script>
@stop
