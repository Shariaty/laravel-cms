            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('route' => ['admin.magazines.categories.create'], 'method' => 'POST' , 'id' => 'AddNewsCategoryForm')) !!}
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <div class="md-checkbox" style="margin-top: 30px;">
                                        <input name="is_published" type="checkbox" id="checkbox2" class="md-check">
                                        <label for="checkbox2">
                                            <span class="inc"></span>
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="">
                                <div class="pull-right">
                                    <a href="{{route('admin.magazines.categories')}}" class="btn btn-danger">Cancel</a>
...
@section('header')
<link href="{{ Module::asset('magazines:plugins/icheck/skins/all.css') }}" rel="stylesheet" type="text/css" />
@stop

@section('moduleFooter')
<script src="{{ Module::asset('magazines:plugins/icheck/icheck.min.js') }}" type="application/javascript"></script>
