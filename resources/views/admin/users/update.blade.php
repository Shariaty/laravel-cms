            ...
            <div class="panel-body form">
                <div class="panel panel-grey">
                    ...
                    <div class="panel-body">
                        {!! Form::model(array($user , 'route' => 'admin.user.update', 'method' => 'POST' , 'id' => 'AdminRegisterForm')) !!}
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-12">
                                    ...
                                    <p class="text-right small-grey-text" style="margin-top: -10px">Password should be at least 6 characters / Leave empty if you do not wish to change</p>
                                </div>
                                <div class="col-md-4 col-xs-12">
                                    ...
                                    <div class="form-group {{ $errors->has('permission_id') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-icon right">
                                            @if($errors->has('permission_id'))
                                                <i class="fa fa-exclamation tooltips" data-container="body"></i>
                                            @endif
                                            {!! Form::select('permission_id[]' , getAdminRolsList() , $selectedCategory , ['class' => 'form-control input-sm select2', 'multiple' , 'size' => 1 , 'style' => 'width: 100%' , 'id' => 'cat_list' ]) !!}
